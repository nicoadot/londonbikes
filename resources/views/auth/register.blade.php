    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}" id="formRegistro">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="errorConfirmPass" class="text-danger"></div>
                            </div>
                        </div>
...
<script src="/js/validadorRegistro.js"></script>
