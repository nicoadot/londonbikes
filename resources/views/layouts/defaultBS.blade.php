...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="/css/styles3.css" id="theme_css" media="all" />
  ...
  <body>
    ...
    <footer class="footer-distributed">
        ...
        <p>
          <div class="divTemas" >
            <img src="imagenes/original.gif" id='imgOriginal' width="150" alt="Cambiar Tema" style="cursor:pointer">
          </div>
          <div class="divTemas" >
            <img src="imagenes/altern.gif" id='imgAltern' width="150" alt="Cambiar Tema" style="cursor:pointer">
          </div>
